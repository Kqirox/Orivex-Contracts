...
| [`api`](https://github.com/orivex/orivex-api)             | Backend API for user management and rewards     | Node.js, Express, PostgreSQL         |
| [`app`](https://github.com/orivex/orivex)                 | Mobile-first PWA frontend                       | React, Next.js, TypeScript, Tailwind |
...
git clone https://github.com/orivex/orivex-api.git
cd orivex-api
